...
class AuthManager:
    ...
    def get_auth_headers(self, context):
        ...
        def get_user_info(self, context):
            ...
            return {
            :getattr(context.window_manager, 'vibe4d_user_id', ''),
            : getattr(context.window_manager, 'vibe4d_user_email', ''),
            :getattr(context.window_manager, 'vibe4d_user_plan', ''),
            : getattr(context.window_manager, 'vibe4d_user_token', '')
            }
