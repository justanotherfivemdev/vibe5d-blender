...
class TextInput(UIComponent):
    ...
    def _build_key_dispatch_table(self) -> dict:
        ...
        :lambda e: self._handle_arrow_key('LEFT', False, False),
        : lambda e: self._handle_arrow_key('RIGHT', False, False),
        :lambda e: self._handle_arrow_key('UP', False, False),
        : lambda e: self._handle_arrow_key('DOWN', False, False),
        :lambda e: self._handle_home_key(False),
        : lambda e: self._handle_end_key(False),
        :lambda e: self._handle_page_key('UP', False),
        : lambda e: self._handle_page_key('DOWN', False),

        :lambda e: self._handle_arrow_key('LEFT', True, False),
        : lambda e: self._handle_arrow_key('RIGHT', True, False),
        :lambda e: self._handle_arrow_key('UP', True, False),
        : lambda e: self._handle_arrow_key('DOWN', True, False),
        :lambda e: self._handle_home_key(True),
        : lambda e: self._handle_end_key(True),
        :lambda e: self._handle_page_key('UP', True),
        : lambda e: self._handle_page_key('DOWN', True),

        :lambda e: self._handle_arrow_key('LEFT', False, True),
        : lambda e: self._handle_arrow_key('RIGHT', False, True),
        :lambda e: self._handle_ctrl_home_end('HOME', False),
        : lambda e: self._handle_ctrl_home_end('END', False),
        :lambda e: self._handle_ctrl_home_end('HOME', True),
        : lambda e: self._handle_ctrl_home_end('END', True),
        :lambda e: self._handle_arrow_key('LEFT', True, True),
        : lambda e: self._handle_arrow_key('RIGHT', True, True),
        ...
        : self._block_key,
        :self._block_key,
        : self._block_key, 'F2': self._block_key, 'F3': self._block_key,
        :self._block_key, 'F5': self._block_key, 'F6': self._block_key,
        :self._block_key, 'F8': self._block_key, 'F9': self._block_key,
        :self._block_key, 'F11': self._block_key, 'F12': self._block_key,
        }
